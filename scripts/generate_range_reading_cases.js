...
const boardProfiles = [
  {
    ...
    board: "A72r",
    type: "Aハイドライ",
    small: ["made", "topPair", "overcards", "air"],
    pressure: ["made", "topPair"],
  ...
  },
  {
    ...
    board: "QJ5tt",
    type: "高カード2枚ツートーン",
    small: ["made", "topPair", "draw", "overcards"],
    pressure: ["made", "topPair", "draw"],
    check: ["underpair", "overcards", "draw", "air"],
    attack: ["made", "topPair", "draw"],
  ...
  },
  {
    ...
    attack: ["made", "topPair", "draw", "underpair"],
